...
import { Award, TrendingUp, Shield, FileText } from 'lucide-react';
...
function Transparency({ isPreview = false }) {
  ...
  // Update the metrics array with null checks
  const metrics = [
    {
    ...
    const fetchStats = async () => {
      try {
        ...
        setStats({
          ...
          auditFrequency: data.auditFrequency || 'Not Set',
          totalMembers: data.totalMembers || 0,
          fundsCollected: data.fundsCollected || 0,
          fundsUsed: data.fundsUsed || 0,
