...
function Donate() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 pb-16 text-white">
      {/* Add a spacer div for header */}
      <div className="h-24"></div> {/* This creates space for the fixed header */}
